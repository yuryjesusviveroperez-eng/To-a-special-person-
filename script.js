...
/* =========================================================
   ...
   3. En "Reglas" de Firestore, pega esto y publica:
      ...
      (Esto deja el chat abierto a quien tenga el código de la
      sala, igual que compartir un enlace. No hay login porque
      esta app es solo para ustedes dos; guarden el código en
      privado.)
...
const App = {
  ...
  eventos() {
    ...
    // El cierre del visor (botón .close y clic fuera de la imagen) ya lo
    // cubren los listeners genéricos de arriba, porque #modal-visor
    // también tiene la clase .modal.
  },
